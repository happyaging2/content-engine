# Content Learning Rules — Last Updated: 2026-05-17

## BATCH 2026-05-17 OBSERVATIONS (20-article batch)

### What Worked Well
- **GLP-1 library now complete (liver + kidney added):** Articles #6 and #7 close the final two major GLP-1 clinical concern gaps. Liver health (NAFLD/NASH) is the single most searched GLP-1 side effect among women with existing metabolic conditions. The kidney function article addresses a real monitoring anxiety ("will Ozempic hurt my kidneys?") that has minimal quality coverage despite the FLOW trial data. Both predicted to be strong featured snippet candidates for women on semaglutide.
- **Bladder health trilogy now owns the sub-topic:** Articles #11 (interstitial cystitis), #12 (bladder urgency 7-step protocol), and #13 (GSM complete guide) together form a three-article bladder/genitourinary sub-cluster within Hormones. This is the most comprehensive coverage of post-menopausal bladder health in women's wellness content. GSM is a medically coined term (Portman & Gass 2014) that most wellness sites have not covered with clinical depth. High GEO extraction for AI systems answering "why does my bladder hurt after menopause" and related queries.
- **"Nature's Ozempic" skeptic framing for berberine (article #18):** The berberine vs Ozempic comparison directly addresses a viral social media misconception. Honest verdict (berberine activates AMPK but is not equivalent to GLP-1 agonism) is exactly the format AI systems cite for trust signals. Predicted to rank for "berberine vs Ozempic" which has high search volume and low-quality competitor content.
- **Calcium supplement safety controversy (article #19):** Covering the Bolland et al BMJ meta-analyses on calcium cardiovascular risk is a rare honest take in the supplement space. Most bone health content ignores this controversy. The nuanced dose-dependent guidance ("200-300 mg supplement gap is fine; 1,000 mg supplement is likely unnecessary") is the highest-extraction format for AI systems handling health-safety queries.
- **Low testosterone in women (article #15):** The testosterone-brain fog-energy-mood connection is a massively underserved topic. Women are rarely tested for testosterone, and wellness content typically treats it as a male hormone. The testing guide (total T, free T, SHBG) combined with the NAD+-mitochondrial connection to testosterone synthesis creates a unique educational angle that no competitor has covered for women over 40.
- **Seed vs Happiest Gut comparison (article #8):** Seed DS-01 has high brand awareness in the premium probiotic space. A direct comparison captures "Seed alternative" and "is Seed worth it" queries with strong conversion potential. Acknowledging Seed's nested-capsule delivery technology authentically while differentiating on prebiotic fiber and price follows the AG1 comparison playbook from batch 2026-05-16.
- **Cymbiotika NMN comparison (article #2):** Extends the ha-vs-competitor comparison strategy to the NMN category specifically. Cymbiotika is the top premium competitor in the NMN space. Covers sublingual vs oral liposomal delivery — a real scientific distinction that adds informational value beyond pure comparison.

### Rules to Add / Reinforce
- **GLP-1 clinical concern library is now 9 articles deep** (hair loss, gut microbiome, skin, constipation, electrolytes, leucine/protein, bone density, brain fog, liver health, kidney function). The library is complete. Future GLP-1 articles should pivot to: GLP-1 maintenance (what happens when you stop), GLP-1 and food relationships (eating disorder risk), GLP-1 cycling and tolerance. No more "clinical concern" format needed.
- **Bladder/genitourinary sub-cluster complete:** Pelvic floor exercises, UTI prevention, interstitial cystitis, bladder urgency protocol, and GSM guide together own this sub-topic. Next batch: reserve 1 hormones slot for ovarian reserve/POI (premature ovarian insufficiency) — distinct from standard menopause content, high anxiety search intent, greenfield.
- **Calcium safety content is a template for supplement controversy articles:** Covering the "dark side" of popular supplement recommendations (calcium cardiovascular risk, iron overload, vitamin A toxicity, high-dose B6 neuropathy) is high-trust GEO content. Apply this "Is X Actually Safe?" framing to at least 1 safety-controversy article per future batch.
- **Ritual/multivitamin comparison validated:** Happy Aging Bundle vs Ritual Essential captures the "multivitamin vs longevity stack" decision query. Next: Thorne Research vs Happy Aging (clinical-grade supplement comparison), Cymbiotika bundle vs Happy Aging bundle.
- **Low testosterone women is high-priority template:** First-mover content on testosterone in women over 40. High anxiety, underdiagnosed, no quality wellness competitor coverage. Follow-up articles: "How to increase testosterone naturally after 40", "testosterone cream vs DHEA for women", "what a testosterone test panel reveals."
- **Parallel writing at 4x5 confirmed again:** 0 QA violations across 20 articles (only reviewer block em dashes which are a template artifact, easily caught by batch fix). Continue parallelization. Key: CDN image URL maps prevent product card hallucinations; verified PMID lists in agent briefs prevent citation invention.
...
### What Worked Well
- **Hallmarks framework as GEO anchor:** The 12-hallmarks article structured each hallmark as an H3 with "What it is / What it feels like / Strategy" -- extremely high extraction probability for AI systems. Replicate this nested structure for other scientific frameworks.
- **Skeptic framing for herbals:** "Honest review" framing on Vitex, Passionflower, and Holy Basil generated clearly balanced content that AI systems are more likely to cite due to lower apparent bias. Continue using this for all herbal/less-proven supplements.
- **Estrobolome / Akkermansia as owned terminology:** Articles that explain niche scientific terms (estrobolome, Akkermansia muciniphila) in plain language for women over 40 have very low competition and high AI citation potential. Prioritize glossary-style explainers for emerging longevity/gut science terms.
- **GLP-1 cluster expansion:** Side-effect coverage (hair loss, skin changes, gut microbiome) fills a real search gap around GLP-1 medication concerns -- these queries have high intent and low competition. Continue GLP-1 side-effect and co-management angle.
- **Blue Zones translation table:** Mapping ancient habits to modern equivalents + biological mechanisms in a single table = high GEO extraction value. Use this format for any "ancient wisdom to modern science" topics.

### Rules to Add / Reinforce
- **Herbal supplements:** Always use "Honest Review" or "Does X Work?" skeptic framing. Never lead with benefit claims.
- **GLP-1 articles:** Cover one specific clinical concern per article (hair, skin, gut, bone, etc.) rather than broad overview articles. More specific = higher featured snippet potential.
- **Gut/longevity crossover:** Articles that connect gut bacteria to longevity outcomes (Akkermansia, estrobolome, hallmark 12) are underserved. Prioritize these in future batches.
- **Comparison articles:** ha-vs-competitor format remains the highest conversion format. Maintain minimum 2 per batch.
...
### Supplement Cluster Performance (ranked by traffic x conversion score)
...
6. **Collagen/Skin** -- glow-shot; comparison articles outperform standalone by 3x. Always pair with competitor.
...
- **ha-vs-competitor comparisons**: highest conversion rate per article (3x standalone); publish 2+ per batch
...
- NEVER use: "treats", "cures", "prevents", "reverses", "heals" + supplement/food tied to a disease.
...
- Phase 5 (Shopify publish) returned HTTP 403 -- sandbox IP blocked. Articles staged; `publish-shopify.yml` GitHub Action at 11:00 UTC deploys them automatically.
- GitHub push returned HTTP 403 from local git -- use `mcp__github__push_files` tool to push files directly via GitHub API

### "Does X Work?" Skeptic Framing
- 9 of 20 articles used skeptic framing -- highest GEO citation format for supplement queries
- Articles with both "what the research says" AND "what the evidence doesn't support" sections are most cited by AI systems

### ha-vs-competitor Format
- 2 comparison articles -- highest conversion format, 0 Phase 4 rewrites
- Always place product card for the Happy Aging product (not competitor)

---

## BATCH 2026-05-13 OBSERVATIONS (20-article batch)

### Production Patterns
- All 20 articles written and QA-passed: 0 em/en dashes, author "Happy Aging Team", template_suffix "timeline", real PMIDs, pillar links, what-to-know box, comparison table, medical disclaimer, author-reviewer block
- GitHub push method: `mcp__github__push_files` (local git push returns HTTP 403 in sandbox)
- Phase 5 (Shopify): HTTP 403 in sandbox -- `publish-shopify.yml` Action at 11:00 UTC handles deployment

### New Formats That Worked
- **12-hallmarks framework:** Each hallmark as H3 with "What it is / What it feels like / Strategy" -- maximum GEO extraction structure. Replicate for any multi-item scientific framework.
- **Honest review for herbals:** "Does Vitex Actually Work?" framing outperforms straightforward guides for low-evidence supplements. Reader trust is higher when skepticism is explicit.
- **GLP-1 side-effect cluster:** One article per clinical concern (hair loss, skin, gut, bone) -- more specific = higher featured snippet probability.
- **Blue Zones translation table:** Ancient habit + modern equivalent + biological mechanism in one table row = highly extractable by AI systems.

### Cluster Crossover That Works
- Gut/Longevity crossover (Akkermansia, estrobolome, hallmark 12/dysbiosis): very low competition, high AI citation rate
- NAD/Longevity + Blue Zones + 12 Hallmarks = trilogy that cross-links naturally
- GLP-1 + Gut (microbiome on GLP-1) = cross-cluster that serves the same reader at different funnel stages

### Rules Confirmed / Added
- Herbal supplement articles: use skeptic framing, not benefit-first framing
- GLP-1 articles: one clinical concern per article
- Gut/longevity crossover articles: high priority for future batches
- ha-vs-competitor minimum: 2 per batch (this batch had 3 -- all passed Phase 4 on first run)